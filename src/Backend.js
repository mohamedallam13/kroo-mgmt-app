(function (root, factory) {
  ...
  function importAppData() {
    const { mgmSysInterface, membersQRObj } = readFromJSON(MASTER_INDEX_ID)
    const members = readFromJSON(membersQRObj)
    const configs = readFromJSON(mgmSysInterface)
    return JSON.stringify({ members, configs })
  }
